    ...
    return (
        <div className="grid space-y-2" onKeyDown={(e) => handleKeyPress(e)}>
            ...
            <div className="relative group" tabIndex={1}>
                <button onClick={toggleDropdown} type="button" role="combobox" id="select" value="Select" aria-controls="listbox" aria-haspopup="listbox" aria-expanded="false" className="peer capitalize border border-[#828FA340] px-4 py-2 rounded-md body-l">
                ...
                {isDropdownOpen && (
                    <ul role="listbox" id="listbox" className={`drop-shadow bg-white dark:bg-darkBg transition-[display] duration-300 ease-in-out rounded-md absolute z-20 text-white right-0 left-0 top-12 max-h-36 overflow-y-auto snap-mandatory snap-y px-4 group-focus:block group-focus-within:block hidden`}>

...
export default function SideBar() {
    ...
    return (
        <nav>
            <div className={`flex flex-col pr-6 bg-white dark:bg-darkGrey fixed w-[300px] duration-300 transition-[left] border-r border-lightLines dark:border-darkLines h-screen  ${isSidebarOpen ? 'left-0 mr-[300px]' : '-left-80 mr-0'}`}>
            ...
            <div>
                ...
                {!isSidebarOpen && <button onClick={()=> setSidebarOpen(!isSidebarOpen)} className="fixed bottom-0 left-0 w-14 flex items-center justify-center mb-8 py-5 bg-primaryPurple text-white hover:bg-lightPurple rounded-r-full">

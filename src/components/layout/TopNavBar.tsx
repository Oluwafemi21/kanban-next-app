        ...
        <>
            <header className="flex items-center justify-between dark:bg-darkGrey bg-white py-5 pr-6 pl-4 md:p-0">
                <div className="flex items-center gap-4">
                    <div className={`border-r border-lightLines dark:border-darkLines py-4 px-6 md:py-8 hidden md:block *:transition-[display] *:ease-in-out ${open ? 'sm:w-[261px] lg:w-[300px]' : null}`}>
